...
%2. Timing
%3. Directed search
%4+5. Unemp+emp workers
%6. Contracts (here explain both recursivity AND the tenure approximation. Appendix reference to a dual problem proof (time to type it out!!!)
%7. Free-entry
%8. Eq-m definition
%I like this more personally.
%Or cedomir's (vsimilar), wherehe describesthe entire market first (bsedies eq-m definition) THEN goesinto decision problems. So almost the sameas Souchier except free-entry is earlier

%So, following this structure, I could also have a 
