...
\begin{proposition} \label{prop:layoffs}
  ...
  \begin{equation}
    -E_{y'|y}\frac{\partial J'}{\partial n'_{k+1}}(1-p(v'_{k+1}))+E_{y'|y}\frac{\partial J'}{\partial z'_{k+1}}\frac{\partial z'_{k+1}}{\partial s_k} - \frac{R(v'_{k+1})-U}{u'(w_k)}\leq 0
  \end{equation}
...
\end{proposition}
\begin{proof}
  \textcolor{red}{Envelope Theorem Application}
\end{proof}
