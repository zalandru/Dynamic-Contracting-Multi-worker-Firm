...
% Define colors
\definecolor{statecolor}{RGB}{0,128,0}       % green
\definecolor{ctrlcolor}{RGB}{255,140,0}      % orange
\definecolor{excolor}{RGB}{255,0,255}        % magenta
\definecolor{nextstatecolor}{RGB}{0,0,255}    % blue

\subsection{Variables}
\subsection*{\textcolor{statecolor}{Endogenous state variables}}
\begin{align*}
&\textcolor{statecolor}{n_{k,t}}, \textcolor{statecolor}{\rho_{k,t}}, \textcolor{statecolor}{z_{k,t}}
\end{align*}
\textbf{Code:} \texttt{states: size, rho, q}

\subsection*{\textcolor{excolor}{Exogenous state variables}}
\begin{align*}
&\textcolor{excolor}{y_t}
\end{align*}
\textbf{Code:} \texttt{z}

\subsection*{\textcolor{ctrlcolor}{Control variables}}
\begin{align*}
&\textcolor{ctrlcolor}{\tilde{n}}, \textcolor{ctrlcolor}{\rho^*_k}, \textcolor{ctrlcolor}{s_k}
\end{align*}
\textbf{Code:} \texttt{hiring, rho\_star, sep\_star}

\subsection{Equations}
Equations (1)--(21): \textcolor{statecolor}{states} in \textcolor{statecolor}{green}, \textcolor{ctrlcolor}{controls} in \textcolor{ctrlcolor}{orange}, next period \textcolor{excolor}{exogenous} in \textcolor{excolor}{magenta}, next period \textcolor{nextstatecolor}{controls} in \textcolor{nextstatecolor}{blue}, parameters in black.
\begin{align}
0&=\lambda_t-\frac{\nu_t}{C_t - b_{habit}C_{t-1}}+\beta b_{habit}E_t\bigl[\textcolor{excolor}{\tfrac{\nu_{t+1}}{C_{t+1}-b_{habit}C_t}}\bigr]\\
