...
def make_params_coarse():
    ...
    return Parameters(overwrite={ 'tol_simple_model': 1e-5, 'tol_full_model': 1e-6, 'sim_ni': 5000, 'sim_nrep': 3, 'sim_nt': 44, 'sim_nt_burn': 50, 'sim_nh': 100})
    #    'tol_simple_model': 1e-5,   # looser than 1e-6
    #    'tol_full_model':   1e-5,   # looser than 1e-6
    #    'sim_ni':           5000,   # shrink for speed
