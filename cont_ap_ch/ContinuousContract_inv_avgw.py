...
class ContinuousContract_inv:
    ...
    def J(self,update_eq=1):    
        ...
        for ite_num in range(self.p.max_iter):
            ...
            foc = rho_grid[ax, :] - (EJinv/pc)* (log_diff / self.deriv_eps) #first dim is productivity, second is future marg utility, third is today's margial utility
            ...
            print("J without wage",Ji[self.p.z_0-1,:]+w_grid)
