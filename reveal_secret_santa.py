...
def main():
    participants = ["Andryoushenka", "Serezhenka", "Goshenyonok", "Marselchik", "Marinushka"]
    constraints = [
        ("Serezhenka", "Marinushka"), ("Marinushka", "Serezhenka"), ("Goshenyonok", "Marselchik"), ("Marselchik", "Goshenyonok"),
        ("Goshenyonok", "Andryoushenka"), ("Andryoushenka", "Goshenyonok")
    ]
