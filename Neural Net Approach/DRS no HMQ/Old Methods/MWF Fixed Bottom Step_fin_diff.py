...
class ValueFunctionNN(nn.Module):
    ...
    def __init__(self, state_dim, num_y, hidden_dims=[40, 30, 20, 10]):
        ...
        for hidden_dim in hidden_dims:
            ...
            layers.append(nn.LeakyReLU(0.1))  # LeakyReLU activation function: allows slightly negative values
...
class PolicyNN(nn.Module):
    ...
    def _init_weights(self):
        ...
        for seq in (self.value_head, self.wage_head, self.hiring_head):
            for layer in seq:
                if isinstance(layer, nn.Linear):
