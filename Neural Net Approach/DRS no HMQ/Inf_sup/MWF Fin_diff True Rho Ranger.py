...
class FOCresidual:
    ...
    def values(self, states, prod_states, EJ_star, v_prime, pc_star, re_star, hiring, future_grad):
        ...
        grad[~s_pos,K_n:] = 0 #If no seniors, the rho today should in fact be zero. THIS IS IMPORTANT BY THE WAY. SHOULD NOT ALLOW FOR CASES WHERE WE HAVE NO SENIORS BUT RHO IS NON-ZERO.
...
def initialize(bounds_processor, state_dim, K_n, K_v, hidden_dims, learning_rate, weight_decay, pre_training_steps, num_epochs):
    #Initializations:
        ...
        for mb in minibatches:    
            ...
            if ((batch_index) % 4)==0: #Policy Update
                ...
                for it_inf in range(2):
                    ...
                    inf_loss = nn.SmoothL1Loss()(future_grad[:,K_n:], v_prime)
...
if __name__ == "__main__":
    ...
    K_n, K_v, HIDDEN_DIMS, learning_rate=[1e-3,1e-3,1e-3], weight_decay = [1e-4, 1e-4, 1e-4], pre_training_steps=200, num_epochs=num_episodes)
