...
class FOCresidual:
    ...
    def future_values(self, n_1, prod_states, fut_states, omega, v_prime, hiring, value_net):
        ...
        EJ_star = ERho_star.unsqueeze(1) - omega * n_1 * v_prime #This should all be sup shape
        ...
        for mb in minibatches:    
            ...
            if ((batch_index) % minibatch_num)==0: #Inf Update, happens only once per episode
                ...
                for it_inf in range(1):
                    ...
                    inf_loss = nn.MSELoss()(future_grad[:,K_n:], v_prime * n_1)
