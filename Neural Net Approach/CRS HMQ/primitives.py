...
class Parameters:
    ...
    def __init__(self, overwrite={}):
        ...
        #HMQ
        self.q_0 = 0.75 #Starting match q
        self.prod_q = 0.1 #Relative prodctitivity of a low q match. So, total productivity is sum (prod_q+q_grid*(1-prod_q))*N_grid #Under no HMQ firm doesnt fire

        # Unemployment Parameters
        self.u_bf_m = 0.4        #1.0 * self.dt  #0.05?? sooo low # Intercept of benefit function for unemployed(x)
        #Min wage
        ...
        self.kappa    = 0.4         # Vacancy cost parameter
